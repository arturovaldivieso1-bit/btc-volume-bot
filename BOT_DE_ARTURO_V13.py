...
# =========================
# RADAR 5 – ESTRUCTURA LENTA (pullback a zona macro)
# =========================
...
def radar_estructura_lenta(precio_actual, zonas_macro, regimen):
    """
    Si el régimen es ACUMULACION o DISTRIBUCION, y el precio está cerca de una zona macro,
    genera un setup de pullback.
    """
...
if __name__ == "__main__":
    print("🚀 Iniciando BOT V13.4 (volumen como filtro principal, texto simplificado)...")
